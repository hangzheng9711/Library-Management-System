...
public class AdminDelBookUI {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminDelBookUI window = new AdminDelBookUI();
	...
	private void initialize() {
		...
		JLabel step = new JLabel("Step1：选择删除书籍");
		...
		ok2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
        		...
        		operator.book_account=strArray[0];
					AdminDelBook2UI adminDelBook2=new AdminDelBook2UI();
					adminDelBook2.frame.setVisible(true);
					frame.dispose();
			}
		});	
