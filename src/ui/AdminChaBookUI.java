...
public class AdminChaBookUI {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminChaBookUI window = new AdminChaBookUI();
	...
	private void initialize() {
		...
		JLabel step = new JLabel("Step1：选择修改书籍");
		...
		ok2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
        		...
        		operator.book_account=strArray[0];
					AdminChaBook2UI adminChaBook2=new AdminChaBook2UI();
					adminChaBook2.frame.setVisible(true);
					frame.dispose();
			}
		});	
