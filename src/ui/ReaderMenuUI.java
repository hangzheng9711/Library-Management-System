...
public class ReaderMenuUI {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ReaderMenuUI window = new ReaderMenuUI();
	...
	private void initialize() {
		...
		JComboBox paixu = new JComboBox();
		paixu.setModel(new DefaultComboBoxModel(new String[] {"书号", "书名"}));
		paixu.setBounds(45, 95, 80, 25);
		panel.add(paixu);
		
		JLabel la_paixu = new JLabel("排序：");
		la_paixu.setBounds(6, 98, 39, 16);
		panel.add(la_paixu);
		
		JLabel la_shuhao = new JLabel("书号：");
		la_shuhao.setBounds(45, 11, 39, 16);
		panel.add(la_shuhao);
		
		JLabel la_shuming = new JLabel("书名：");
		la_shuming.setBounds(148, 11, 52, 16);
		panel.add(la_shuming);
		
		JLabel la_chubanshe = new JLabel("出版社：");
		la_chubanshe.setBounds(45, 40, 73, 16);
		panel.add(la_chubanshe);
		
		JTextField shuhao = new JTextField();
		shuhao.setBounds(83, 6, 53, 26);
		panel.add(shuhao);
		shuhao.setColumns(10);
		
		JTextField shuming = new JTextField();
		shuming.setBounds(190, 6, 214, 26);
		panel.add(shuming);
		shuming.setColumns(10);
		
		JTextField chubanshe = new JTextField();
		chubanshe.setColumns(10);
		chubanshe.setBounds(93, 35, 199, 26);
		panel.add(chubanshe);
		JLabel la_chubanriqi = new JLabel("出版日期：");
		la_chubanriqi.setBounds(309, 40, 73, 16);
		panel.add(la_chubanriqi);
		
		JTextField chubanriqi = new JTextField("单击选择日期");
		chubanriqi.setBounds(375, 35, 130, 26);
		...
		String order=paixu.getSelectedItem().toString();
		...
		{   
			...
			str.add(new String(String.format("%-10s%-25s%-13s%-15s%-12s%-10s%s",s1,s2,s3,s4,s5,s6,s7)));
		}
		...
		label.setBounds(6, 134, 39, 16);
		panel.add(label);
		
		JLabel label_1 = new JLabel("书名");
		label_1.setBounds(57, 134, 39, 16);
		panel.add(label_1);
		
		JLabel label_2 = new JLabel("作者");
		label_2.setBounds(190, 134, 39, 16);
		panel.add(label_2);
		
		JLabel label_3 = new JLabel("出版社");
		label_3.setBounds(267, 134, 52, 16);
		panel.add(label_3);
		
		JLabel label_4 = new JLabel("出版日期");
		label_4.setBounds(403, 134, 52, 16);
		panel.add(label_4);
		
		JLabel label_5 = new JLabel("总数");
		label_5.setBounds(466, 134, 39, 16);
		panel.add(label_5);
		
		JLabel label_6 = new JLabel("目前在馆数");
		label_6.setBounds(507, 134, 79, 16);
		panel.add(label_6);
