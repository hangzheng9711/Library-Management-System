...
public class ReaderInfoUI {
	...
	private JTextField zhenghao;
	private JTextField ximing;
	private JTextField nianji;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ReaderInfoUI window = new ReaderInfoUI();
